...
urlpatterns = [
    ...
    path('items/<int:pk>/eliminar/', ItemMaterialDeleteView.as_view(), name='item_delete'),
    ...
    path('stocks/<int:pk>/eliminar/', StockMaterialDeleteView.as_view(), name='stock_delete'),
